...
## [0.6.1](https://github.com/guiaramos/strev/compare/v0.6.0...v0.6.1) - 2026-06-29

### Added

- *(strev)* add Recoverer middleware to catch handler panics

### Other

- release v0.5.0 ([#11](https://github.com/guiaramos/strev/pull/11))
...
- *(strev-redis)* add Redis Streams pubsub backend

### Fixed

- *(strev-redis)* prevent premature subscriber shutdown
